 ...
 * from the worker's transcription, typed ones straight off the chat topic. Shown
 * in full to both people: a message the other person cannot see is not a message.
 */
