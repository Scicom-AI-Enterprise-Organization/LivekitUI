 ...
 *
 * The case this exists for: both people are in the call, but the worker was still
 * starting when the room was created, so nothing is transcribing. Deploying or
